                ...
                for conf in combinations:
                    try:
                        ...
                        if args.data == "PACS":
                            ...
                            dm = PACSDataModule(root="data/variants/PACS_small", domains=test_domains, contents=contents,
                                                batch_size=batch_size, num_workers=20)
                            log_dm = PACSDataModule(root="data/variants/PACS_small", domains=test_domains, contents=contents,
