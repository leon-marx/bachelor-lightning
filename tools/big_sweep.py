...
if __name__ == "__main__":
    ...
    configs = {
        "CVAE_v3": {
            ...
            "kernel_size": [3],
            "activation": ["elu", "selu", "relu", "lrelu"],
            "downsampling": ["stride", "maxpool"],
            "upsampling": ["stride", "upsample"],
            "dropout": [False],
            "batch_norm": [True, False],
            "loss_mode": ["elbo", "l1_elbo", "deep_lpips"],
            "lamb": [0.0, 1e-6, 1e-4, 1e-2],
            "no_bn_last": [True, False],
            "initialize": [True]
            },
        "MMD_CVAE": {
            "data": ["PACS"],
            ...
            "dropout": [False],
            "batch_norm": [True, False],
            "loss_mode": ["elbo", "l1_elbo", "deep_lpips", "mmd"],
            "lamb": [0.0, 1e-6, 1e-4, 1e-2],
            "beta": [0.0, 1e-6, 1e-4, 1e-2],
            "no_bn_last": [True, False],
            "initialize": [True]
            },
        "AAE_v2": {
